...
load("SamplingStrata functions.RData")
```
...
This function controls that the number of auxiliary variables is the same in the frame and in the strata dataframes; that the number of target variables indicated in the frame dataframe is the same than the number of means and standard deviations in the strata dataframe, and the same than the number of coefficient of variations indicated in the errors dataframe.
...
knitr::include_graphics("Rplot_optimize.png")
```
...
```{r, out.width = "300px", echo = FALSE}
knitr::include_graphics("Rplot_kmeans.png",dpi=NA)
```
...
```
```{r, out.width = "300px", echo = FALSE}
knitr::include_graphics("Rplot_optimize_kmeans.png")
```
